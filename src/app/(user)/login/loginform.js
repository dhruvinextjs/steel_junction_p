...
//         }
//         try {
//           const payload = { mobileNumber: data.phone };
...
//             } else {
//               router.push(role === "retailer" ? "/retailer" : "/wholesaler"); // Default fallback
//             }
//           }
//         } catch (error) {
...
//                       render={({ field }) => (
//                         <InputOTP
//                           maxLength={4} // Ensure it matches the OTP length
//                           value={field.value} // Bind the value from React Hook Form
//                           onChange={(value) => field.onChange(value)} // Update the form value
//                         >
